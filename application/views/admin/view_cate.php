                            ...
                            <div class="am-u-sm-12">
                                <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black " id="example-r">
                                    ...
                                    <?php foreach($result as $row){?>
                                        <tr class="gradeX">
                                            <td class="am-text-middle"><?php echo $row->cate_id;?></td>
                                            <td class="am-text-middle"><?php echo $row->cate_name;?></td>
                                            <td><div class="tpl-table-black-operation">
                                                    <a href="Cate/del?cate_id=<?php echo $row->cate_id;?>" class="tpl-table-black-operation-del">
